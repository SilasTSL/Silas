                ...
                <div className={styles.experienceExperienceContainer}>
                    ...
                    <div className={styles.experienceExperienceBodyContainer}>
                        ...
                        <div className={styles.experienceExperienceDetails}>
                            ...
                            <div className={styles.experienceExperienceDetailPointer}><img className={styles.experienceListIcon} src={require("../../images/list-icon.png")}/><p>Exploration and implementation of data collection processes with <span className={styles.highlight}>Azure Databricks</span> and <span className={styles.highlight}>Azure SQL database</span></p></div>
                            ...
                            <div className={styles.experienceExperienceDetailPointer}><img className={styles.experienceListIcon} src={require("../../images/list-icon.png")}/><p>Conceptualized, designed and developed <span className={styles.highlight}>Company’s Landing Page</span> and <span className={styles.highlight}>Customer-Facing Tutorial Hub</span> for company’s API services</p></div>
                        </div>
                    </div>
                </div>
                ...
                <div className={styles.experienceExperienceContainer}>
                    ...
                    <div className={styles.experienceExperienceBodyContainer}>
                        ...
                        <div className={styles.experienceExperienceDetails}>
                            ...
                            <div className={styles.experienceExperienceDetailPointer}><img className={styles.experienceListIcon} src={require("../../images/list-icon.png")}/><p>Helped with development of i<span className={styles.highlight}>&nbsp;Internal Traffic Monitoring Interface</span></p></div>
